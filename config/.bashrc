...
top -bn 1 | grep -Ei .exe --color ; echo --- ; echo 'ps ax|egrep “*\.exe“|grep -v 'egrep'|awk '{print $1 }' | xargs sudo renice -n -2 -p “$ 1“'"
alias renicewine2="ps ax|egrep '*\.exe'|grep -v 'egrep'|awk '{print $1 }' | xargs sudo renice -n -5 -p $1 ; echo --- ; \
top -bn 1 | grep -Ei .exe --color ; echo --- ; echo 'ps ax|egrep “*\.exe“|grep -v 'egrep'|awk '{print $1 }' | xargs sudo renice -n -5 -p “$ 1“'"
alias renicewine3="ps ax|egrep '*\.exe'|grep -v 'egrep'|awk '{print $1 }' | xargs sudo renice -n -8 -p $1 ; echo --- ; \
top -bn 1 | grep -Ei .exe --color ; echo --- ; echo 'ps ax|egrep “*\.exe“|grep -v 'egrep'|awk '{print $1 }' | xargs sudo renice -n -8 -p “$ 1“'"
alias renicewine4="ps ax|egrep '*\.exe'|grep -v 'egrep'|awk '{print $1 }' | xargs sudo renice -n -10 -p $1 ; echo --- ; \
top -bn 1 | grep -Ei .exe --color ; echo --- ; echo 'ps ax|egrep “*\.exe“|grep -v 'egrep'|awk '{print $1 }' | xargs sudo renice -n -10 -p “$ 1“'"
alias reniceuser1="sudo renice -n -2 -u '$USER' ; echo --- ; \
top -bn 1 | grep -Ei $USER --color ; echo --- ; echo 'sudo renice -n -2 -u $USER'"
alias reniceuser2="sudo renice -n -5 -u '$USER' ; echo --- ; \
top -bn 1 | grep -Ei $USER --color ; echo --- ; echo 'sudo renice -n -5 -u $USER'"
alias reniceuser3="sudo renice -n -8 -u '$USER' ; echo --- ; \
top -bn 1 | grep -Ei $USER --color ; echo --- ; echo 'sudo renice -n -8 -u $USER'"
alias reniceuser4="sudo renice -n -10 -u '$USER' ; echo --- ; \
top -bn 1 | grep -Ei $USER --color ; echo --- ; echo 'sudo renice -n -10 -u $USER'"
