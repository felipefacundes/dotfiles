...
static const char *colors[][3]      = {
	/*                    fg         bg         border   */
	[SchemeNorm] = { col_green1, col_abacate3, col_green1 },
...
static Key keys[] = {
	...
	{ MODKEY,                       0x0000ff61, spawn,          SHCMD ("flameshot") },
	...
	{ MODKEY|ControlMask,           XK_w,      spawn,          SHCMD ("cd ~ ; mkdir -p Imagens/Wallpapers/ ; feh --bg-scale $(find /home/$USER/Imagens/Wallpapers/ -name '*[jJpP][nNpP][gG]' | shuf -n1)") },
