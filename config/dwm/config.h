...
static const char *colors[][3]      = {
	...
	[SchemeSel]  = { col_gray4, col_abacate2,  col_abacate1  },
};
...
static const char *shutdowncmd[]  = { "openrc-shutdown", "--poweroff", "now", NULL };
static const char *rebootcmd[]  = { "openrc-shutdown", "--reboot", "now", NULL };
...
static Key keys[] = {
	...
	{ MODKEY|ControlMask,           XK_b,      spawn,          SHCMD ("cd ~ ; pkill -9 barcomplete.sh ; bash .local/bin/barcomplete.sh") },
	{ MODKEY|ControlMask|ShiftMask, XK_BackSpace, spawn,       {.v = rebootcmd } },
	{ MODKEY|ControlMask|ShiftMask, XK_Delete,    spawn,       {.v = shutdowncmd } },
	...
	{ 0,                            0x0000ff61, spawn,          SHCMD ("cd ~ ; mkdir -p 'Imagens/Captura de Tela/' ; cd 'Imagens/Captura de Tela/' ; scrot 'Captura de tela de %d-%m-%Y %H:%M:%S.png' ; play ~/.local/songs/camera_shutter.mp3") },
	{ MODKEY,                       XK_F2,     spawn,          {.v = roficmd } },
	{ MODKEY,                       XK_F1,     spawn,          {.v = menucmd } },
	{ ControlMask|Mod4Mask,         XK_f,      spawn,          {.v = firefoxcmd } },
	{ MODKEY|ControlMask,           XK_w,      spawn,          SHCMD ("feh --bg-scale $(find /home/$USER/Imagens/Wallpapers/ -name '*[jJpP][nNpP][gG]' | shuf -n1)") },
