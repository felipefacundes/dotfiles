...
static const char col_gray_light[]  = "#d7d9d9";
static const char col_gray_cyan[]   = "#b2c0c0";
...
static const char col_cyan2[]       = "#1793c4";
static const char col_cyan3[]       = "#005577";
...
static const char *colors[][3]      = {
	/*                    fg         bg         border   */
    //             Default Scheme: 'Black+Dark-Cyan'
    // [SchemeNorm] = { col_gray3, col_gray1, col_gray2 },
	// [SchemeSel]  = { col_gray4, col_cyan3,  col_cyan3  },
    //                     Abacate Scheme
    // [SchemeNorm] = { col_green1, col_abacate3, col_abacate3 },
	// [SchemeSel]  = { col_abacate3, col_abacate2, col_abacate1 },
    //                    Cyan Light Scheme
    [SchemeNorm] = { col_cyan2, col_gray_light, col_gray_light },
    [SchemeSel]  = { col_cyan2, col_gray_cyan, col_cyan1 },
};
...
static Key keys[] = {
	...
	{ Mod4Mask,                     XK_u,      spawn,          SHCMD ("sakura -t UPDATE -e sudo pacman -Syyu") },
	...
	{ ControlMask|Mod4Mask,         XK_m,      spawn,          SHCMD ("firefox --new-tab about:memory") },
	{ MODKEY|ControlMask,           XK_l,      spawn,          SHCMD ("i3lock") },
	{ Mod4Mask,                     XK_m,      spawn,          SHCMD ("vmg") },
	{ MODKEY|ControlMask,           XK_t,      spawn,          SHCMD ("qbittorrent") },
	{ MODKEY|ControlMask,           XK_r,      spawn,          SHCMD ("sakura -e ffmpeg -video_size 1920x1080 -framerate 25 -f x11grab -i :0.0 -f pulse -ac 2 -i default ~/Vídeos/Tela_$(date +%d-%m-%Y_%H:%M:%S).mkv") },
