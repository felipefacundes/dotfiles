...
alias renicewine="ps ax|egrep '*\.exe'|grep -v 'egrep'|awk '{print $1 }' | xargs sudo renice -n -19 -p $1 ; echo --- ; \
echo 'ps ax|egrep “*\.exe“|grep -v 'egrep'|awk '{print $1 }' | xargs sudo renice -n -19 -p “$ 1“'"
alias reniceuser="sudo renice -n -19 -u '$USER' ; echo --- ; \
echo 'sudo renice -n -19 -u $USER'"
